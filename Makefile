...
install: $(DESTDIR)$(SYSTEMD_HOME)
	install --compare --verbose -m 0755 -d $(DESTDIR)$(PREFIX)/sbin $(DESTDIR)$(PREFIX)/share/man/man8
	install --compare --verbose -m 0755 src/zfs-auto-snapshot.sh $(DESTDIR)$(PREFIX)/sbin/zfs-auto-snapshot
	install --compare --verbose -m 0644 -t $(DESTDIR)$(PREFIX)/share/man/man8 src/zfs-auto-snapshot.8
	install --compare --verbose -m 0644 -t $(DESTDIR)$(SYSTEMD_HOME) \
